...
export default function Distributors() {
                 ...
                 useEffect(() => {
                   selectedMenuItem !== "distributors" &&
                     dispatch({
                       type: "SELECT_MENU_ITEM",
                       menuItem: "distributors"
                     });
                 ...
                 var data = useSelector(
                   state => state.dataPerMenuItem.distributors.content
                 );
                             ...
                             <ButtonGroup>
                               <Button
                                 ...
                                 onClick={() => {
                                   axios({
                                     method: "delete",
                                     url: `/distributors/${tableMeta.rowData[0]}`
                                   })
                                     .then(response => {
                     ...
                     <Grid container spacing={4}>
                       <Grid item xs={12}>
                         {!isLoading && (
                           ...
                           >
                             <CardHeader
                               title="Total Distributors Count"
                               ...
                               axios({
                                 ...
                                 .then(response => {
                                   ...
                                   if (response.status === 200) {
                                     ...
                                     dispatch(
                                       fetchDataIfNeeded("distributors")
                                     );
                                   }
                                 })
                                 .catch(error => {
